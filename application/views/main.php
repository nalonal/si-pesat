...
<html>
        ...
        <nav class="navbar navbar-default hidden-print">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?=base_url()?>" style="margin-top:0px; font-size:28px; color:black">
                        <img src="<?=base_url()?>public/images/ikon2.png" style="margin-top:-10px;" width="40px" align="left">|SIPESAT
                    ...
                    <ul class="nav navbar-nav navbar-left visible-xs">
                        ...
                        <li class="<?= $pageTitle == 'Items' ? 'active' : '' ?>">
                            <a href="<?= site_url('items') ?>">
                                ...
                                Manajemen Barang
                                 <!-- Manajemen Barang <i style="color: red">(<?php echo $item ?>)</i> -->
                            </a>
                        </li>
    ...
    <!--                     <li class="<?= $pageTitle == 'Opname' ? 'active' : '' ?>">
             ...
             <!--            <li class="<?= $pageTitle == 'Transit' ? 'active' : '' ?>">
                            <a href="<?= site_url('transit') ?>">
                                <i class="fa fa-truck"></i>
                                Barang Transit
                            </a>
                        </li> -->

                         <li class="<?= $pageTitle == 'Kartu' ? 'active' : '' ?>">
                            <a href="<?= site_url('kartu') ?>">
                    ...
                    <ul class="nav nav-pills nav-stacked pointer">
                        ...
                        <li class="<?= $pageTitle == 'Items' ? 'active' : '' ?>">
                            <a href="<?= site_url('items') ?>">
                                <i class="fa fa-briefcase"></i>
                                Manajemen Barang
                                <!-- Manajemen Barang<?php if($item != 0){ ?><i style="color: red">(<?php echo $item ?>)</i><?php } ?> -->
                            </a>
                        </li>
            ...
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    <div class="modal-header hidden-print">
                        ...
                        <h4 class="text-center">Tanda Terima Transaksi</h4>
                    </div>
                        ...
                        <form name="logInModalForm">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-2 pull-right">
                                    <button id='loginModalSubmit' class="btn btn-primary">Masuk</button>
                                </div>
                            </div>
                        </form>
                    </div>

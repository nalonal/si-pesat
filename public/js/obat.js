...
$(document).ready(function(){
    ...
    $("#editItemSubmit").click(function(){
        ...
        $.ajax({
            ...
            data: {itemName:itemName, itemPrice:itemPrice, itemDesc:itemDesc, _iId:itemId, itemCode:itemCode, itemKategori:itemKategori, itemQuantity:itemQuantity, itemMinimal:itemMinimal}
